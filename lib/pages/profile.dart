...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    final user = FirebaseAuth.instance.currentUser;
    final extraTopPadding = MediaQuery.of(context).padding.top + kToolbarHeight + 15;
                      ...
                      Container(
                        ...
                        child: Card(
                          ...
                          child: ExpansionTile(
                            ...
                            leading: Icon(Icons.support_agent, color: Colors.red[700]),
                            title: Text('Support', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red[800])),
                            children: [
                              Padding(
